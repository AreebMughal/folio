...
const HeroSection = React.memo(() => {
  ...
  const renderSocialLinks = (): React.ReactNode =>
    Object.keys(SOCIAL_LINKS).map((el: keyof typeof SOCIAL_LINKS) => (
      <a href={SOCIAL_LINKS[el]} key={el} className={HERO_STYLES.SOCIAL_LINK} rel="noreferrer" target="_blank">
    ...
    <div className={HERO_STYLES.CONTENT}>
      <div className="md:mb-4 mb-2">
        <h2 className="text-4xl seq">
          Hello{' '}
          <span
            className="inline-block text-5xl origin-bottom-right"
            style={{
        ...
        <h1 className="text-3xl seq">
          I&#39;m <span className="section-heading !text-4xl">Areeb Arshad</span>
        </h1>
      </div>
      <p className="mb-4">
  ...
  return (
    <section className={HERO_STYLES.SECTION} id={heroSectionRef} ref={targetSection} style={{ opacity: 0 }}>
      {renderHeroContent()}
